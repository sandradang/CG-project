...
void CompileLists()
{
	...
	glNewList(BoxList, GL_COMPILE);
		...
		glBegin(GL_QUADS);
			/* Front */
			glTexCoord2d(0, 0); glVertex3d(400, 125, 100);
			glTexCoord2d(1, 0); glVertex3d(750, 125, 100);
			glTexCoord2d(1, 1); glVertex3d(750, 475, 100);
			glTexCoord2d(0, 1); glVertex3d(400, 475, 100);

			/* Left side */
			glTexCoord2d(0, 0); glVertex3d(400, 125, -100);
			glTexCoord2d(1, 0); glVertex3d(400, 125, 100);
			glTexCoord2d(1, 1); glVertex3d(400, 475, 100);
			glTexCoord2d(0, 1); glVertex3d(400, 475, -100);

			/* Back */
			glTexCoord2d(0, 0); glVertex3d(750, 125, -100);
			glTexCoord2d(1, 0); glVertex3d(400, 125, -100);
			glTexCoord2d(1, 1); glVertex3d(400, 475, -100);
			glTexCoord2d(0, 1); glVertex3d(750, 475, -100);
			...
			glTexCoord2d(0, 0); glVertex3d(400, 125, -100);
			glTexCoord2d(1, 0); glVertex3d(750, 125, -100);
			glTexCoord2d(1, 1); glVertex3d(750, 125, 100);
			glTexCoord2d(0, 1); glVertex3d(400, 125, 100);

			/* Bottom */
			glTexCoord2d(0, 0); glVertex3d(400, 475, -100);
			glTexCoord2d(1, 0); glVertex3d(750, 475, -100);
			glTexCoord2d(1, 1); glVertex3d(750, 475, 100);
			glTexCoord2d(0, 1); glVertex3d(400, 475, 100);
		glEnd();
	glEndList();
	...
	//#### DOORPOLYGON ####
	FlatpolyList = glGenLists(1);
	glNewList(FlatpolyList, GL_COMPILE);

		glBegin(GL_QUADS);
			glTexCoord2d(0, 0); glVertex3d(400, 125, -1);
			glTexCoord2d(1, 0); glVertex3d(750, 125, -1);
			glTexCoord2d(1, 1); glVertex3d(750, 475, -1);
			glTexCoord2d(0, 1); glVertex3d(400, 475, -1);
		glEnd();
	glEndList();
	//###### END ######
...
//################### DOOR ###################
		...
		glPushMatrix();
			...
			glTranslated(1000, 250, -5000);
			glRotatef(-180, 0, 0, 1.0);
			glCallList(FlatpolyList);
		glPopMatrix();

//#################### END ####################


//################### LOCK CODE NOT FINISHED ###################
		
		//* CODE, ONE POLYGON FOR EACH NUMBER *//
		glPushMatrix();
			glScaled(0.2, 0.1, 1);
			glTranslated(0, 0, 1000);
			for (short i(0); i < 3; ++i)
			{
				glBindTexture(GL_TEXTURE_2D, Textures[6+i]);
...
int main(int argc, char **argv)
{
	...
	Textures[3] = GrabTexObjFromFile("Data/door.png");
	Textures[4] = GrabTexObjFromFile("Data/pianotexture.png");
	Textures[5] = GrabTexObjFromFile("Data/pianokey1.png");
	Textures[6] = GrabTexObjFromFile("Data/no1.png");
	Textures[7] = GrabTexObjFromFile("Data/no2.png");
	Textures[8] = GrabTexObjFromFile("Data/no4.png");
